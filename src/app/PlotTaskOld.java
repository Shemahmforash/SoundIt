 ...
 * @author wanderer
 */
public class PlotTaskOld extends SwingWorker<Void, Void> {
     ...
     * @param color
     */
    public PlotTaskOld(ArrayList<Float> samples, String title, int width, int height, int samplesPerPixel, Color color) {
     ...
     * @param play
     */
    public PlotTaskOld(ArrayList<Float> samples, String title, int width, int height, int samplesPerPixel, Color color, String fileName, boolean play) {
     ...
     * @param hopSize
     */
    public PlotTaskOld(ArrayList<Float> samples, String title, int width, int height, int samplesPerPixel, Color color, int hopSize) {
        this(samples, title, width, height, samplesPerPixel, color);
     ...
     * @param hopSize
     */
    public PlotTaskOld(ArrayList<Float> samples, String title, int width, int height, int samplesPerPixel, Color color, String fileName, boolean play, int hopSize) {
